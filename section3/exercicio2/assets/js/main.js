...
button.addEventListener('click', function(){
    if(isNaN(peso.value) || isNaN(altura.value)){
        ...
        if(calcular(peso.value, altura.value) < 18.5){
            imcResult.innerHTML += `<p>Menor que 18.5</p>`
